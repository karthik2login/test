...
using GithubResearch.Sessions;
using GithubResearch.Web.Controllers.Results;
using GithubResearch.Web.Models;
using GithubResearch.Web.Models.Account;
...
{
    public class AccountController : GithubResearchControllerBase
    {
